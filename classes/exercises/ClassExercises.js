...
myNovel.checkout(101)
myNovel.dispose();
console.log(`${myNovel.discarded}. Pride and Prejudice has been discarded.\n`);

myManual.dispose(2023)
console.log(`${myManual.discarded}. Top Secret Shuttle Building Manual has been discarded.\n`);